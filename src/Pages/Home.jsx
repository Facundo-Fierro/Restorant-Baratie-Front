    ...
    <Container fluid className="home-page">
      <Row >
        <Col  className="nav-col d-flex ">
          <Nav  className="nav justify-content-between flex-row" variant="underline" defaultActiveKey={['0']} >
      ...
      <Row className="justify-content-center align-items-center flex-column" style={{ minHeight: '90vh' }} >
        ...
        <Col className="d-flex justify-content-center hacerpedido">
            <div className="llama">
        <button  className="textButton" onClick={gotoMenu}>Hacer Pedido</button>
        </div>
        </Col>
      </Row>
    </Container>
